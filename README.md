...
### Пакетный режим (опционально)
Для автоматизации можно запускать с предустановленным номером заказа:
```bash
...
Подробное описание каждого шага доступно в файле [SCENARIO.md](scenario.md).
